...
echo "
		<p style=\"margin-left: 1em;\">
			<a href=\"home/fpp/media/plugins/remote-falcon/logs/$date.txt\">Download FPP Log From $date</a>
			<br />
			<a href=\"home/fpp/media/plugins/remote-falcon/logs/$date2.txt\">Download FPP Log From $date2</a>
			<br />
			<a href=\"home/fpp/media/plugins/remote-falcon/logs/$date3.txt\">Download FPP Log From $date3</a>
		</p>
	";
